...
namespace Project_Keystone.Controllers
{
    public class StatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StatusID,StatusName,StatusDesc,StatusColor")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusID,StatusName,StatusDesc,StatusColor")] Status status)
        {
