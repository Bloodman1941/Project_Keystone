...
namespace Project_Keystone.Controllers
{
    public class PrioritiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PriorityID,PriorityName,PriorityDesc,PriorityColor,PriorityLevel")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PriorityID,PriorityName,PriorityDesc,PriorityColor,PriorityLevel")] Priority priority)
        {
